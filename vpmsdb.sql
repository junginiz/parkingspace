...
CREATE TABLE transactions (
    ...
    FOREIGN KEY (user_id) REFERENCES tblregusers(ID),
    FOREIGN KEY (parking_space_id) REFERENCES tblparkingspaces(ID)
);
INSERT INTO transactions (user_id, parking_space_id, amount, status, transaction_date) 
VALUES 
(1, 1, 20.00, 'completed', '2024-04-13 08:30:00'),
(2, 2, 25.00, 'completed', '2024-04-13 09:00:00'),
(3, 3, 30.00, 'pending', '2024-04-13 10:15:00'),
(1, 4, 15.00, 'cancelled', '2024-04-13 11:30:00'),
(2, 5, 40.00, 'completed', '2024-04-13 12:45:00');
